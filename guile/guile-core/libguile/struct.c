...
scm_init_struct ()
{
  ...
  scm_define ("vtable-index-layout", SCM_MAKINUM (scm_vtable_index_layout));
  scm_define ("vtable-index-vtable", SCM_MAKINUM (scm_vtable_index_vtable));
  scm_define ("vtable-index-printer", SCM_MAKINUM (scm_vtable_index_printer));
  scm_define ("vtable-offset-user", SCM_MAKINUM (scm_vtable_offset_user));
