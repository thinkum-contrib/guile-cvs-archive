...
scm_init_regex_posix ()
{
  ...
  /* Compilation flags.  */
  scm_define ("regexp/basic", scm_long2num (REG_BASIC));
  scm_define ("regexp/extended", scm_long2num (REG_EXTENDED));
  scm_define ("regexp/icase", scm_long2num (REG_ICASE));
  scm_define ("regexp/newline", scm_long2num (REG_NEWLINE));

  /* Execution flags.  */
  scm_define ("regexp/notbol", scm_long2num (REG_NOTBOL));
  scm_define ("regexp/noteol", scm_long2num (REG_NOTEOL));
