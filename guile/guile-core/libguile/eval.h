...
extern SCM scm_m_nil_cond SCM_P ((SCM xorig, SCM env));
extern SCM scm_m_nil_ify SCM_P ((SCM xorig, SCM env));
extern SCM scm_m_t_ify SCM_P ((SCM xorig, SCM env));
extern SCM scm_m_0_cond SCM_P ((SCM xorig, SCM env));
extern SCM scm_m_0_ify SCM_P ((SCM xorig, SCM env));
extern SCM scm_m_1_ify SCM_P ((SCM xorig, SCM env));
extern SCM scm_m_atfop SCM_P ((SCM xorig, SCM env));
extern SCM scm_m_atbind SCM_P ((SCM xorig, SCM env));
