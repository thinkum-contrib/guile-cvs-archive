...
;; use this mechanism as well.  We use the special `tcltk
  ...
  (let* ((module (current-module))
    ...
    (save-module-excursion
     (lambda ()
       ...
       (let* ((modname (list 'tcltk '%static-initfuncs%
...
(define default-module-prefix 'tcltk)
